...
> [!NOTE]
> **Looking for a place to start?** Check out [our long term plan for RiseMP](https://github.com/orgs/Rise-Software/projects/4/views/1), which details planned features and changes.
